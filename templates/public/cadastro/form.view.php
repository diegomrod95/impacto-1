...
<div class="form-group">
  ...
  <span class="help-block">O e-mail será usado para ter acesso à área do aluno e comunicar-se diretamente com a Impacto.</span>  
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    ...
    <span class="help-block">A senha deve ter entre 6 e 30 caracteres Ex.: senha@123</span>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    ...
    <span class="help-block">A senha deve ser a mesma que a anterior.</span>
  </div>
</div>
...
<div class="form-group">
  ...
  <span class="help-block">O campo deve estar no formato: 999.999.999-99</span>  
  </div>
</div>
...
<div class="form-group">
  ...
  <span class="help-block">O campo deve estar no formato: dia/mês/ano</span>  
  </div>
</div>
...
<div class="form-group">
  ...
  <span class="help-block">O campo deve estar no formato: (11) 9999-9999</span>  
  </div>
</div>
...
<div class="form-group">
  ...
  <span class="help-block">O campo deve estar no formato: (11) 90000-0000</span>  
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <button id="btn_enviar" name="btn_enviar" class="btn btn-success">Cadastrar</button>
